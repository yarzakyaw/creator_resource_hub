import 'package:creator_resource_hub_mobile/features/resources/data/resource_repository.dart';
...
final filteredResourcesProvider = FutureProvider<List<Resource>>((ref) {
  final repository = ref.read(resourceRepositoryProvider);
  final typeFilter = ref.watch(resourceTypeFilterProvider);
  final collection = '${typeFilter?.name.toLowerCase() ?? ''}_resources';
